...
import 'package:amazon_clone_app/commom/widgets/stars.dart';
...
class _ProductDeatilScreenState extends State<ProductDeatilScreen> {
  final ProdcutDetailsServices productDeatilsServices =
  ...
  void addToCart() {
    productDeatilsServices.addToCart(
      context: context,
          ...
          children: [
            ...
            RatingBar.builder(
              ...
              itemBuilder: (context, _) => const Icon(
                Icons.star,
                color: GlobalVariables.secondryColor,
              ),
